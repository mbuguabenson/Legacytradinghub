const DEFAULT_SITES = {
  default: {
    id: 'legacytradinghub',
    siteId: 'legacytradinghub',
    name: 'Legacy Trading Hub',
    appName: 'Legacy Trading Hub',
    logoTextMain: 'Legacy',
    ...
    derivAppId: '34upwmAmuO1weyybB7ptp',
    allowedDomains: ['legacytradinghub.vercel.app', 'www.legacytradinghub.vercel.app', 'localhost', '127.0.0.1'],
    primaryDomain: 'legacytradinghub.vercel.app',
    primaryColor: '#1e40af',
    accentColor: '#3b82f6',
    activeTabColor: '#3b82f6',
    botButtonColor: '#1d4ed8',
    botBuilderColor: '#0c1432',
    secondaryColor: '#0f172a',
    backgroundColor: '#04091f',
    fontFamily: 'Inter',
    fontGoogleParam: 'Inter:wght@300;400;500;600;700;800',
    referralUrl: '',
    redirectUrl: 'https://legacytradinghub.vercel.app',
    specialAccounts: [],
    marketingAccounts: [],
  },
  legacytradinghub: {
